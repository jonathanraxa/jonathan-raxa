...
- Developed video prototype for instructor/student interaction using JavaScript, jQuery, HTML, and CSS`);
    ...
    const copyText = (val) => {
        if (['dr-duties', 'plm-duties', 'gap-duties', 'lq-duties', 'sfsu-duties'].includes(val)) {
            switch (true) {
                case val === 'dr-duties':
        ...
        <div className="Experience position-relative" id="experience">
            ...
            <div className="datarobot mb-3">
                <div className="row no-gutters">
                    <div className="col-md-2" >
                        <span className="hover-copy" onClick={() => copyText('Nov 2020')}>Aug 2021</span> - <span className="hover-copy" onClick={() => copyText('Present')}>May 2025</span>
                    </div>
                    <div onClick={() => copyText('DataRobot')} className="col-md-8 text-uppercase hover-copy">
                        <strong>DataRobot</strong>
                    </div>
                    <div onClick={() => copyText('Greater Boston')} className="col-md-2 hover-copy"><strong>Greater Boston (remote)</strong></div>
                </div>

                <div className="row no-gutters">
                     <div onClick={() => copyText('Front-End Software Engineer')} className="offset-md-2 position_title hover-copy">Front-End Software Engineer</div>
                </div>

                <div className="row no-gutters">
                    <div className="offset-md-2">
                        <ul className="pl-3 mb-0 hover-copy" onClick={() => copyText('plm-duties')}>  
                            <li><strong className="colorRed">Development skills:&nbsp;</strong><i>Development skills: React JS, JavaScript, JEST, Cypress E2E, React-Query, TypeScript</i></li>
                            <li>Developing, maintaining, and upgrading various features for our SaaS product</li>
                            <li>Developing, maintaining, and upgrading various features and aspects of in-house design-system</li>
                            <li>Implement architectural and design patterns for the flagship site, React component library, and other node modules</li>
                            <li>Working closely with product development to determine the scope, breakdown, and sequencing of proposed features</li>
                            <li>Conducting peer code reviews using Git and necessary code pairing</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div className="patientslikeme mb-3">
                <div className="row no-gutters">
                    <div className="col-md-2" >
                        <span className="hover-copy" onClick={() => copyText('Nov 2020')}>Nov 2020</span> - <span className="hover-copy" onClick={() => copyText('Present')}>Aug 2021</span>
                    </div>
                    <div onClick={() => copyText('PatientsLikeMe, LLC')} className="col-md-8 text-uppercase hover-copy">
                ...
                <div className="row no-gutters">
                    <div className="offset-md-2">
                        <ul className="pl-3 mb-0 hover-copy" onClick={() => copyText('plm-duties')}>  
                            <li><strong className="colorRed">Development skills:&nbsp;</strong><i>React JS, HTML/CSS, JavaScript, HAML, Ruby, Rails, SASS, Bootstrap, Jest/Enzyme, Git</i></li>
                            <li>Developing features for PLM website using React, React Context, and Bootstrap library</li>
                            <li>Implement architectural and design patterns for flagship site, React component library, and Sass node modules</li>
                            <li>Working closely with product development to determine scope, breakdown, and sequencing of proposed features</li>
            ...
            <div className="gapinc mb-3">
                <div className="row no-gutters">
                    <div className="col-md-2" >
                        <span className="hover-copy" onClick={() => copyText('Sep 2016')}>Sep 2016</span> - <span className="hover-copy" onClick={() => copyText('Nov 2020')}>Nov 2020</span>
                    </div>
                    <div className="col-md-8 text-uppercase hover-copy" onClick={() => copyText('Gap Inc.')}><strong>Gap Inc.</strong></div>
                    <div className="col-md-2 hover-copy" onClick={() => copyText('San Francisco, CA')}><strong>San Francisco, CA</strong></div>
                </div>

                <div className="row no-gutters">
                    <div className="offset-md-2 position_title hover-copy" onClick={() => copyText('Front-End Web Content Developer')}>Front-End Web Content Developer</div>
                </div>

                <div className="row no-gutters">
                    <div className="offset-md-2">
                    <ul className="pl-3 mb-0 hover-copy" onClick={() => copyText('gap-duties')}>  
            ...
            <div className="lqdigital mb-3">
                <div className="row no-gutters">
                    <div className="col-md-2" >
                        <span className="hover-copy" onClick={() => copyText('Feb 2016')}>Feb 2016</span> - <span className="hover-copy" onClick={() => copyText('Sep 2016')}>Sep 2016</span>
                    </div>
                    <div className="col-md-8 text-uppercase hover-copy" onClick={() => copyText('LQ Digital')}><strong>LQ Digital</strong></div>
                    <div className="col-md-2 hover-copy" onClick={() => copyText('Emeryville, CA')}><strong>Emeryville, CA</strong></div>
                </div>
                ...
                <div className="row no-gutters">
                    <div className="offset-md-2">
                    <ul className="pl-3 mb-0 hover-copy" onClick={() => copyText('lq-duties')}>  
            ...
            <div className="sfsu">
                <div className="row no-gutters">
                    <div className="col-md-2">
                        <span className="hover-copy" onClick={() => copyText('Jun 2012')}>Jun 2012</span> - <span className="hover-copy" onClick={() => copyText('Feb 2016')}>Feb 2016</span>
                    </div>
                    <div className="col-md-8 text-uppercase hover-copy" onClick={() => copyText('SFSU I.T. Department (ITS) | College of Education I.T. (POETS)')}><strong>SFSU I.T. Department (ITS) | College of Education I.T. (POETS)</strong></div>
                    <div className="col-md-2 hover-copy" onClick={() => copyText('San Francisco, CA')}><strong>San Francisco, CA</strong></div>
                </div>

                <div className="row no-gutters">
                    <div className="offset-md-2 position_title hover-copy" onClick={() => copyText('Technology Consultant | General IT Assistant')}>Technology Consultant | General IT Assistant</div>
                </div>

                <div className="row no-gutters">
                    <div className="offset-md-2">
                    <ul className="pl-3 mb-0 hover-copy" onClick={() => copyText('sfsu-duties')}>  
            ...
            >
                Copied&nbsp;<span><i>{currentText}</i></span>
             </a>
             }
        </div>
    )
