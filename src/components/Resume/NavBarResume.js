    ...
    render() {
        return (
            <nav className="NavBarResume sticky-top navbar navbar-expand-lg navbar-dark bg-dark">
                <RouteLink to={{ pathname: '/jonathan-raxa' }} className="navbar-brand">Jonathan Raxa</RouteLink>
                ...
                <div className={this.state.isToggleOn ? 'collapse navbar-collapse show' : 'collapse navbar-collapse'}
                    ...
                    <div className="navbar-nav ml-auto justify-content-end">
                        ...
                        <ScrollLink to="projects" onClick={this.handleClick} activeClass="active" spy={true} smooth={true} offset={-100} duration={10} className="nav-item nav-link capitalizeLi">projects</ScrollLink>
                        ...
                        <ScrollLink to="personal" onClick={this.handleClick} activeClass="active" spy={true} smooth={true} offset={-100} duration={10} className="nav-item nav-link capitalizeLi">personal</ScrollLink>
                ...
                <p id="back-top">
                    <ScrollLink to="page-top" smooth={true} duration={10}><i className="fa fa-angle-up"></i></ScrollLink>
                </p>
            </nav>
