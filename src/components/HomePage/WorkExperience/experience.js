...
export const EXPERIENCE = [
    ...
    },
    {
      ...
      skills: "React JS, HTML/CSS, JavaScript (jQuery), Salesforce B2C Development, Front-End Design",
      description: [
    ...
    },
    {
      ...
      skills: "React JS, HTML/CSS, JavaScript, HAML, Ruby, Rails, SASS, Bootstrap, Jest/Enzyme, Git",
      description: [
