...
export const TechExperienceOne = () => {
    return (
        <div>
            <div className="row">
                <div className="col-lg-12 text-center" style={{ paddingTop: '2em'}}>
                    <div className="mz-about-container">
                        ...
                        <ul>
                            <li><strong>Development skills:&nbsp;</strong>HTML/CSS, JavaScript (jQuery), Salesforce B2C Development, Front-End Design</li>
