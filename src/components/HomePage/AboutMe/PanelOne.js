        ...
        <div className="col-md-4">
            <div className="team-item">
                <div className="team-image photoOfMe">
                    <img src={IMAGES.profile_photo} style={panelOneImg} className="img-responsive" alt="author: jon raxa" />
                </div>
                <div className="team-text">
                <a className="page-scroll" href="#portfolio"><h3>WEB DEVELOPER<br />&<br />Content Creator</h3></a>
