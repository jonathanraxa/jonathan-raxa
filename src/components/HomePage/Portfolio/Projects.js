...
export const PROJECT_PROMODRAWER = (
    <Portfolio
...
export const PROJECT_TEMPLATE_CREATOR = (
    <Portfolio
...
export const PROJECT_GOOGLESCRIPT = (
    <Portfolio
...
export const PROJECT_RUBYSCRIPT = (
    <Portfolio
...
export const PROJECT_PHOTOWORLD = (
        <Portfolio
...
export const PROJECT_PERSONALWEBSITE = (
    <Portfolio
